    ...
    fn float_to_device(tensor: FloatTensor<Self>, device: &Device<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for ToDevice {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_to_device", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_add_scalar(lhs: FloatTensor<Self>, rhs: FloatElem<B>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for AddScalar {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_add_scalar", ops.parents, ops.node, grads, |grad| grad);
            }
        }
    ...
    fn float_sub_scalar(lhs: FloatTensor<Self>, rhs: FloatElem<B>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for SubScalar {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_sub_scalar", ops.parents, ops.node, grads, |grad| grad);
            }
        }
    ...
    fn float_mul_scalar(lhs: FloatTensor<Self>, rhs: FloatElem<B>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for MulScalar {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_mut_scalar", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_div_scalar(lhs: FloatTensor<Self>, rhs: FloatElem<B>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for DivScalar {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_div_scalar", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_remainder_scalar(lhs: FloatTensor<Self>, rhs: FloatElem<B>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for RemainderScalar {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_remainder_scalar", ops.parents, ops.node, grads, |grad| grad);
            }
        }
    ...
    fn float_neg(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Neg {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_neg", ops.parents, ops.node, grads, |grad| B::float_neg(grad));
            }
        }
    ...
    fn float_recip(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Recip {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_recip", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_swap_dims(tensor: FloatTensor<Self>, dim1: usize, dim2: usize) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for SwapDim {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_swap_dims", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_permute(tensor: FloatTensor<Self>, axes: &[usize]) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for PermuteDim {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_permute", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_flip(tensor: FloatTensor<Self>, axes: &[usize]) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for FlipDim {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_flip", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_reshape(tensor: FloatTensor<Self>, shape: Shape) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for ReshapeDim {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_reshape", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_gather(
        ...
        impl<B: Backend> Backward<B, 1> for Gather {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_gather", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_select(
        ...
        impl<B: Backend> Backward<B, 1> for Select {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_select", ops.parents, ops.node, grads, |grad| {
                    let zeros = B::float_zeros(shape, &device);
    ...
    fn float_slice(
        ...
        impl<B: Backend> Backward<B, 1> for Index {
            ...
            fn backward(
                ...
                unary::<B, _>(&"slice", ops.parents, ops.node, grads, |grad| {
                    let zeros = B::float_zeros(shape, &device);
    ...
    fn float_mask_fill(
        ...
        impl<B: Backend> Backward<B, 1> for MaskFill {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_mask_fill", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_mean(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Mean {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_mean", ops.parents, ops.node, grads, |grad| {
                    let shape = ops.state;
    ...
    fn float_sum(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Sum {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_sum", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_mean_dim(tensor: FloatTensor<Self>, dim: usize) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for MeanDim {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_mean_dim", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_sum_dim(tensor: FloatTensor<Self>, dim: usize) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for SumDim {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_sum_dim", ops.parents, ops.node, grads, |grad| {
                    let ones = B::float_ones(shape, &B::float_device(&grad));
                    let grad = B::float_sum_dim(grad, dim);
    ...
    fn float_exp(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Exp {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_exp", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_log(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Log {
            ...
            fn backward(
                ...
                let input = checkpointer.retrieve_node_output(ops.state);
                unary::<B, _>(&"float_log", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_log1p(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Log1P {
            ...
            fn backward(
                ...
                let input = checkpointer.retrieve_node_output(ops.state);
                unary::<B, _>(&"float_log1p", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_powf_scalar(tensor: FloatTensor<Self>, value: f32) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for PowfScalar {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_powf_scalar", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_sqrt(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Sqrt {
            ...
            fn backward(
                ...
                let input = checkpointer.retrieve_node_output(ops.state);
                unary::<B, _>(&"float_sqrt", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_abs(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Abs {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_abs", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_cos(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Cos {
            ...
            fn backward(
                ...
                let input = checkpointer.retrieve_node_output(ops.state);
                unary::<B, _>(&"float_cos", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_sin(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Sin {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_sin", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_tanh(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Tanh {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_tanh", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_round(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Round {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_round", ops.parents, ops.node, grads, |_grad| {
    ...
    fn float_floor(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Floor {
            ...
            fn backward(
                ...
                let (shape, device) = ops.state;
                unary::<B, _>(&"float_floor", ops.parents, ops.node, grads, |_grad| {
                    B::float_zeros(shape, &device)
                })
            }
        }
    ...
    fn float_ceil(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Ceil {
            ...
            fn backward(
                ...
                let (shape, device) = ops.state;
                unary::<B, _>(&"float_ceil", ops.parents, ops.node, grads, |_grad| {
                    B::float_zeros(shape, &device)
                })
            }
        }
    ...
    fn float_erf(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Erf {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_erf", ops.parents, ops.node, grads, |grad| {
    ...
    fn float_sign(tensor: FloatTensor<Self>) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Sign {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_sign", ops.parents, ops.node, grads, |grad|
    ...
    fn float_expand(tensor: FloatTensor<Self>, shape: Shape) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for ExpandDim {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_expand", ops.parents, ops.node, grads, |grad| {
                    let shape_grad = grad.shape();
                    let mut grad = grad;
    ...
    fn float_repeat_dim(tensor: FloatTensor<Self>, dim: usize, times: usize) -> FloatTensor<Self> {
        ...
        impl<B: Backend> Backward<B, 1> for Repeat {
            ...
            fn backward(
                ...
                unary::<B, _>(&"float_repeat_dim", ops.parents, ops.node, grads, |grad| {
